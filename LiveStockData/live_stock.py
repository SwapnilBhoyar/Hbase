...
def create_table():
    ...
    try:
        ...
        connection.create_table('live_stock_data',{'cf1':dict(max_versions=1),'cf2':dict(max_versions=1),'cf3':dict(max_versions=1),'cf4':dict(max_versions=1),'cf4':dict(max_versions=1),'cf5':dict(max_versions=1)})
...
def import_into_hbase():
    ...
    try:
        connection=create_hbase_connection()
        table = connection.table('live_stock_data')
